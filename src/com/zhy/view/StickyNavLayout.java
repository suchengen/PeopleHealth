...
public class StickyNavLayout extends LinearLayout {
	...
	private void getCurrentScrollView() {
		...
		switch (currentItem) {
		case 0:
			currentViewId = R.id.list_product_detail_image;
			break;
		case 1:
			currentViewId = R.id.list_product_detail_params;
			break;
		case 2:
			currentViewId = R.id.list_product_detail_evelaute;
			break;
		default:
			currentViewId = R.id.list_product_detail_image;
			break;
